...
- Feature: handling all headers as input source:
  ...
  - Since the order inside `inputSources` matter, consider moving `headers` onto the first place to avoid overwrites;
