...
<div className="flex flex-col items-center justify-center py-12">
  <h1 className="text-5xl font-bold text-center mb-6" style={{ color: 'rgb(var(--primary))' }}>
    Express Zod API
  </h1>
  ...
  <div className="flex gap-4">
    <a href="/quickstart" className="px-6 py-3 rounded text-white font-semibold" style={{ backgroundColor: 'rgb(var(--primary))' }}>
      Get Started
    </a>
    <a href="https://github.com/robintail/express-zod-api" className="px-6 py-3 rounded border-2 font-semibold" style={{ borderColor: 'rgb(var(--primary))', color: 'rgb(var(--primary))' }}>
      View on GitHub
    </a>
  </div>
</div>
